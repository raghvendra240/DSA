...
The cost of tree II is 50*1 + 34*2 = 118 </em></span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><br>
<em><span style="font-size:18px"><strong>Example 2:</strong></span></em></p>

<pre style="position: relative;"><em>
...
Cost of this BST is 1*50 + 2*34 + 3*8 = 142</em></span></em><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
